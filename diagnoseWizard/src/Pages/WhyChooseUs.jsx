...
const WhyChooseUs = (props) => {
    ...
    return (
        <section className="my-[100px] text-start" id="WhyChooseUs" ref={props.WhyChooseUsSection}>
            <div >
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 lg:flex lg:justify-between w-[1073px] px-[75px] ">
                ...
                <div className="flex-col lg:w-[1120px] text-start px-[75px]">
